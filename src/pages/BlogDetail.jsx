    ...
    return (
        <div className="bg-bg-light min-h-screen pt-24 pb-12 font-sans">
            ...
            <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg prose-blue text-gray-700 leading-relaxed mb-16">
                ...
                <p className="mb-6">
                    Modern digital load cells, like the ones ScaleMaster integrates with, provide diagnostics. Monitor these for error codes or inconsistent readings between cells.
                </p>

                <h2 className="text-2xl font-bold text-dark mt-12 mb-4">Conclusion</h2>
                <p className="mb-6">
                    Maintaining your weighbridge is maintaining your bottom line. With digital tools like ScaleMaster, you can track maintenance schedules and spot anomalies before they become problems.
                </p>
            </article>
