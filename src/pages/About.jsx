...
const About = () => {
    ...
    const timeline = [
        { year: "2020", title: "Inception", description: "ScaleMaster was born out of a need for better weighing systems." },
            ...
            <section className="py-24 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-medium text-lg">The passionate team behind ScaleMaster.</p>
                    </div>
