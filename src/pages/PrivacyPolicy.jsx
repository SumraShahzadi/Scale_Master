            ...
            <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl p-8 md:p-12 lg:p-16">
                ...
                <div className="prose prose-blue max-w-none text-gray-700">
                    <p className="lead text-lg">
                        At ScaleMaster, we take your privacy seriously. This Privacy Policy describes how we collect, use, and protect your personal information when you use our SaaS platform.
                    </p>
